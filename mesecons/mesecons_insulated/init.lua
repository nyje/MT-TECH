...
minetest.register_alias("mesecons_insulated:insulated_blue_off","mesecons_insulated:insulated_off")
minetest.register_alias("mesecons_insulated:insulated_blue_on","mesecons_insulated:insulated_on")
